(function() {
   ...
   * contains 'oodebug'. (e.g. "http"//....?oodebug")
   *
   ...
   * the original function is used instead.  E.g. "oo.bind(oo.bind(f),
   * obj)" is identical to "oo.bind(f, obj)";
   *
   ...
   * oo' OO support.  Describing what this does in detail is non-trivial so
  ...
  function _makeClass(sklass) {
    ...
    var meta = extend(_metafy(klass, sklass), {superclass: sklass, isooClass: true});
  ...
  // Create the oo object, with the properties we want to make public
  self.oo = {
    // The main oo API  ...
